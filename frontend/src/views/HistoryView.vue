...
const chartViewModes = ref<Record<string, 'all' | 'cpu' | 'gpu_util' | 'gpu_vram'>>({})

const closeWindow = () => { void getCurrentWindow().close() }

const shiftDay = (delta: number) => {
  const current = new Date(day.value)
  if (isNaN(current.getTime())) return
  current.setDate(current.getDate() + delta)
  day.value = current.toISOString().slice(0, 10)
  ...
  <section class="page-window history-window">
    ...
    <div class="history-servers-list">
      ...
      >
        ...
        <!-- Sub-view tabs for this server (All / CPU / GPU util / GPU VRAM) -->
        ...
        <div class="server-charts-stack">
          ...
          <!-- GPU Utilization Breakdown Chart -->
          <div
          ...
          <!-- GPU VRAM Usage Breakdown Chart -->
          <div
