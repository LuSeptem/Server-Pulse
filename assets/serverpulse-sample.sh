#!/bin/sh
# Server Pulse protocol v2 canonical remote sampler.
# Keep this file POSIX sh and LF-only. It is used by both live collection
# and the future server-side agent.
LC_ALL=C
export LC_ALL
umask 077
